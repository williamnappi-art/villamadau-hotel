  ...
  return (
    <>
      ...
      <div className="bg-gray-900 py-16 px-4 text-center text-white">
        ...
        <h1 className="font-serif text-4xl md:text-5xl">I nostri servizi</h1>
        <p className="mt-4 text-gray-400 max-w-xl mx-auto">
          Tutto ciò di cui avete bisogno per un soggiorno senza pensieri a Pula.
        </p>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {servizi.map((servizio) => (
              <div
                key={servizio.titolo}
                className="group flex flex-col bg-cream rounded-xl p-8 hover:shadow-md transition-shadow"
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white text-primary shadow-sm mb-6 group-hover:bg-primary group-hover:text-white transition-colors">
                  {iconeMap[servizio.icona]}
                </div>
                <h2 className="font-serif text-xl text-gray-900 mb-3">{servizio.titolo}</h2>
                <p className="text-sm text-gray-600 leading-relaxed flex-1">{servizio.descrizione}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-cream py-16 text-center px-4">
        <SectionTitle
          title="Pronto a soggiornare da noi?"
