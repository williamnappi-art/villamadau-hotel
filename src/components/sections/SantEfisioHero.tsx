...
export function SantEfisioHero() {
  ...
  return (
    <section className="relative h-screen min-h-[560px] overflow-hidden">
      ...
      <video
        ...
        loop
        playsInline
        poster="/images/camera-1.png"
        className="absolute inset-0 w-full h-full object-cover object-center"
        aria-hidden="true"
      >
        <source src="/images/sant-efisio.mov" type="video/quicktime" />
        <source src="/images/sant-efisio.mov" type="video/mp4" />
      </video>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4">
        <p className="text-xs font-medium uppercase tracking-[0.25em] text-white/70 mb-4">
          1 – 4 Maggio 2025 · Pula, Sardegna
        </p>
        <h1 className="font-serif text-5xl md:text-7xl leading-tight">
          Arriva<br /><em className="italic font-normal">Sant&apos;Efisio</em>
        </h1>
      </div>
    </section>
  )
